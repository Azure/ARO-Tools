module github.com/Azure/ARO-Tools/pipelines

go 1.25.0

require (
	github.com/Azure/ARO-Tools/config v0.0.0-20260227032723-11f678744bf9
...
require (
	...
	github.com/Azure/ARO-Tools/tools/yamlwrap v0.0.0-20260227032723-11f678744bf9 // indirect
